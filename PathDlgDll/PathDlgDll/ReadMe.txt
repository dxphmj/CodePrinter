========================================================================
MICROSOFT 基础类库：PathDlgDll 项目概述
========================================================================


应用程序向导已为您创建了此 PathDlgDll DLL。此 DLL 不仅
演示了 Microsoft 基础类的基本使用方法，还可
作为您编写 DLL 的起点。

此文件概述了组成 PathDlgDll DLL 的每个文件
的内容。
...
PathDlgDll.cpp
这是主 DLL 源文件。它包含类 CPathDlgDllApp。
...
StdAfx.h，StdAfx.cpp
这些文件用于生成名为 PathDlgDll.pch 的预编译头 (PCH) 文件
