...
BOOL CUserDlg::OnInitDialog()
{
	...
	m_userOpen.LoadBitmaps(IDB_USER_NEWUSER1_BITMAP,IDB_USER_NEWUSER2_BITMAP,0,0,IDB_USER_NEWUSER1_BITMAP);
	m_userOpen.SizeToContent(); 
	m_userNew.LoadBitmaps(IDB_USER_EDITUSER1_BITMAP,IDB_USER_EDITUSER2_BITMAP,0,0,IDB_USER_EDITUSER1_BITMAP);
