...
void CEnvDlg::ControlTextChange()
{
	...
	pCodeDlg->m_Label->pInput->pEditText->GetDlgItem(IDC_EDITTEXT_TEXT_STATIC)->SetWindowText(lanStr.c_str());
	lanStr=theApp.myLanguage.LanguageMap["IDC_EDITTEXT_FONT_STATIC"];
	pCodeDlg->m_Label->pInput->pEditText->GetDlgItem(IDC_EDITTEXT_FONT_STATIC)->SetWindowText(lanStr.c_str());
	lanStr=theApp.myLanguage.LanguageMap["IDC_EDITTEXT_DATAFIELD_STATIC"];
	pCodeDlg->m_Label->pInput->pEditText->GetDlgItem(IDC_EDITTEXT_DATAFIELD_STATIC)->SetWindowText(lanStr.c_str());
	//日期编辑界面
	lanStr=theApp.myLanguage.LanguageMap["IDC_DATE_PREVIEW_STATIC"];
	pCodeDlg->m_Label->pInput->pDate->GetDlgItem(IDC_DATE_PREVIEW_STATIC)->SetWindowText(lanStr.c_str());
	lanStr=theApp.myLanguage.LanguageMap["IDC_DATE_DATETIME_STATIC"];
	pCodeDlg->m_Label->pInput->pDate->GetDlgItem(IDC_DATE_DATETIME_STATIC)->SetWindowText(lanStr.c_str());
	lanStr=theApp.myLanguage.LanguageMap["IDC_DATE_FORMAT_STATIC"];
	pCodeDlg->m_Label->pInput->pDate->GetDlgItem(IDC_DATE_FORMAT_STATIC)->SetWindowText(lanStr.c_str());
	lanStr=theApp.myLanguage.LanguageMap["IDC_DATE_FONT_STATIC"];
	pCodeDlg->m_Label->pInput->pDate->GetDlgItem(IDC_DATE_FONT_STATIC)->SetWindowText(lanStr.c_str());
	lanStr=theApp.myLanguage.LanguageMap["IDC_DATE_SKEW_STATIC"];
	pCodeDlg->m_Label->pInput->pDate->GetDlgItem(IDC_DATE_SKEW_STATIC)->SetWindowText(lanStr.c_str());
	lanStr=theApp.myLanguage.LanguageMap["IDC_DATE_SKEW_VALUE_STATIC"];
	pCodeDlg->m_Label->pInput->pDate->GetDlgItem(IDC_DATE_SKEW_VALUE_STATIC)->SetWindowText(lanStr.c_str());
	lanStr=theApp.myLanguage.LanguageMap["IDC_DATE_SKEW_UNIT_STATIC"];
	pCodeDlg->m_Label->pInput->pDate->GetDlgItem(IDC_DATE_SKEW_UNIT_STATIC)->SetWindowText(lanStr.c_str());
	//条形码编辑界面
	lanStr=theApp.myLanguage.LanguageMap["IDC_BARCODE_TEXT_STATIC"];
	pCodeDlg->m_Label->pInput->pBarCode->GetDlgItem(IDC_BARCODE_TEXT_STATIC)->SetWindowText(lanStr.c_str());
	lanStr=theApp.myLanguage.LanguageMap["IDC_BARCODE_SET_STATIC"];
	pCodeDlg->m_Label->pInput->pBarCode->GetDlgItem(IDC_BARCODE_SET_STATIC)->SetWindowText(lanStr.c_str());
	lanStr=theApp.myLanguage.LanguageMap["IDC_BARCODE_SIZE_STATIC"];
	pCodeDlg->m_Label->pInput->pBarCode->GetDlgItem(IDC_BARCODE_SIZE_STATIC)->SetWindowText(lanStr.c_str());
	lanStr=theApp.myLanguage.LanguageMap["IDC_ECC_LEVEL_STATIC"];
	pCodeDlg->m_Label->pInput->pBarCode->GetDlgItem(IDC_ECC_LEVEL_STATIC)->SetWindowText(lanStr.c_str());
	lanStr=theApp.myLanguage.LanguageMap["IDC_ENCODING_MODE_STATIC"];
	pCodeDlg->m_Label->pInput->pBarCode->GetDlgItem(IDC_ENCODING_MODE_STATIC)->SetWindowText(lanStr.c_str());
	lanStr=theApp.myLanguage.LanguageMap["IDC_BARCODE_DYNAMIC_EDIT_STATIC"];
	pCodeDlg->m_Label->pInput->pBarCode->GetDlgItem(IDC_BARCODE_DYNAMIC_EDIT_STATIC)->SetWindowText(lanStr.c_str());
	lanStr=theApp.myLanguage.LanguageMap["IDC_BARCODE_FIGURE_BTN"];
	pCodeDlg->m_Label->pInput->pBarCode->GetDlgItem(IDC_BARCODE_FIGURE_BTN)->SetWindowText(lanStr.c_str());
	lanStr=theApp.myLanguage.LanguageMap["IDC_BARCODE_DATE_BTN"];
	pCodeDlg->m_Label->pInput->pBarCode->GetDlgItem(IDC_BARCODE_DATE_BTN)->SetWindowText(lanStr.c_str());
	//序列号编辑界面
	lanStr=theApp.myLanguage.LanguageMap["IDC_PREVIEW_STATIC"];
	pCodeDlg->m_Label->pInput->pEditFigure->GetDlgItem(IDC_PREVIEW_STATIC)->SetWindowText(lanStr.c_str());
	lanStr=theApp.myLanguage.LanguageMap["IDC_FIRST_QUARTILE_STATIC"];
	pCodeDlg->m_Label->pInput->pEditFigure->GetDlgItem(IDC_FIRST_QUARTILE_STATIC)->SetWindowText(lanStr.c_str());
	lanStr=theApp.myLanguage.LanguageMap["IDC_FOUR_QUARTILE_STATIC"];
	pCodeDlg->m_Label->pInput->pEditFigure->GetDlgItem(IDC_FOUR_QUARTILE_STATIC)->SetWindowText(lanStr.c_str());
	lanStr=theApp.myLanguage.LanguageMap["IDC_START_STATIC"];
	pCodeDlg->m_Label->pInput->pEditFigure->GetDlgItem(IDC_START_STATIC)->SetWindowText(lanStr.c_str());
	lanStr=theApp.myLanguage.LanguageMap["IDC_STEP_SIZE_STATIC"];
	pCodeDlg->m_Label->pInput->pEditFigure->GetDlgItem(IDC_STEP_SIZE_STATIC)->SetWindowText(lanStr.c_str());
	lanStr=theApp.myLanguage.LanguageMap["IDC_REPEAT_COUNT_STATIC"];
	pCodeDlg->m_Label->pInput->pEditFigure->GetDlgItem(IDC_REPEAT_COUNT_STATIC)->SetWindowText(lanStr.c_str());
	lanStr=theApp.myLanguage.LanguageMap["IDC_BIT_DATA_STATIC"];
	pCodeDlg->m_Label->pInput->pEditFigure->GetDlgItem(IDC_BIT_DATA_STATIC)->SetWindowText(lanStr.c_str());
	lanStr=theApp.myLanguage.LanguageMap["IDC_COUNTER_STATIC"];
	pCodeDlg->m_Label->pInput->pEditFigure->GetDlgItem(IDC_COUNTER_STATIC)->SetWindowText(lanStr.c_str());
	lanStr=theApp.myLanguage.LanguageMap["IDC_FONT_STATIC"];
	pCodeDlg->m_Label->pInput->pEditFigure->GetDlgItem(IDC_FONT_STATIC)->SetWindowText(lanStr.c_str());
	lanStr=theApp.myLanguage.LanguageMap["IDC_FORMAT_STATIC"];
	pCodeDlg->m_Label->pInput->pEditFigure->GetDlgItem(IDC_FORMAT_STATIC)->SetWindowText(lanStr.c_str());
	//墨水系统-普通界面
