 ...
 * @return an input object (initialized). On error, NULL is returned and int errno
 ...
 * @retval 0 success.
 * @retval -1 an error occurred and int errno is set to indeicate the error.
 ...
 * @return an instance of QRinput_Struct. On error, NULL is returned and int errno
 *         is set to indicate the error.
 * @throw ENOMEM unable to allocate memory.
 */
 ...
 *        set.
 * @return a set of input data. On error, NULL is returned, and int errno is set
 ...
 *         and int errno is set to indicate the error. See Exceptions for the
 *         details.
 * @throw EINVAL invalid input object.
 * @throw ENOMEM unable to allocate memory for input objects.
 */
 ...
 *         int errno is set to indicate the error. See Exceptions for the details.
 * @throw EINVAL invalid input object.
 * @throw ENOMEM unable to allocate memory for input objects.
 */
